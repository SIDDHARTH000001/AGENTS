...
class NewsWorkflow:
    def __init__(self, llm_model="gpt-4o-mini", temperature=0):
        ...
        self.llm_postability = AzureChatOpenAI(temperature = 0.1, deployment_name=os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME"))
    ...
    async def word_count_rewriter_node(
        ...
        print("word_count_rewriter_node")
        print(state)
        print()
        print()
